...
import { publicEncrypt, randomBytes, createHash, createPublicKey, } from "node:crypto";
...
try {
    ...
    console.error("Unable to connect to the database. Logging has been disabled.");
    console.error(error);
}
// Create models
const LoggedMessageModel = sequelize.define("LoggedMessage", {
...
const LoggedVoiceStateModel = sequelize.define("LoggedVoiceState", {
...
function encryptWithSalt(secret, salt) {
...
export async function logMessageActivity(message) {
