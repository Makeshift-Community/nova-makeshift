...
const subcommandResponses = {
    [wikiSubcommandBuilder.name]: {
        ...
        displayEmbed: false,
        disclaimer: "Note: While this community is not operated by Digital Extremes, it is officially endorsed by them",
        disclaimerSource: "https://warframe.fandom.com/wiki/WARFRAME_Wiki:Official_Wiki",
    },
    ...
    [glyphSubcommandBuilder.name]: {
        ...
        displayEmbed: true,
        disclaimer: "Note: This content is not officially endorsed by Digital Extremes",
    },
};
